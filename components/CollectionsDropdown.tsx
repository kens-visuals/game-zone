...
export default function CollectionsDropdown({ game, isDropdownOpen }: Props) {
  ...
  return (
    ...
    >
      ...
      <Link
        href="/collections"
        className="flex w-full items-center justify-center gap-2 rounded-b-md bg-black/20 p-2 text-body-2 backdrop-blur-lg backdrop-filter transition-all duration-300 hover:backdrop-blur-sm md:text-body-1"
      >
